...
interface Context
  extends Omit<ItemCompleteUseAfterEvent, 'source'>,
    ItemUseEventWithPlayerContext {}
...
let listener: BasicEventListener<ItemCompleteUseAfterEvent> | undefined;

// Public API ///

export const itemCompleteUse = (
  action: Action,
  ...
  if (!router || !listener) {
    ...
    listener = new BasicEventListener({
      signal: world.afterEvents.itemCompleteUse,
      callback(event) {
